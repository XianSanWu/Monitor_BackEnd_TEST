...
namespace Services.Implementations
{
   ...
   IUnitOfWorkScopeAccessor scopeAccessor) : ITokenService
    {
        ...
        public async Task<AuthResponse> GetUserTokenByRefreshTokenAsync(string refreshToken, CancellationToken cancellationToken = default)
        {
            ...
            return await repo.GetUserTokenByRefreshTokenAsync(refreshToken, cancellationToken).ConfigureAwait(false);
            #endregion
        }
        ...
        public async Task<string> InsertUserTokenAsync(string userId, string accessToken, DateTime accessTokenExpiresAt, string refreshToken, DateTime refreshTokenExpiresAt, CancellationToken cancellationToken)
        {
            ...
            return await repo.InsertUserTokenAsync(userId, accessToken, accessTokenExpiresAt, refreshToken, refreshTokenExpiresAt, cancellationToken).ConfigureAwait(false);
            #endregion
        }
