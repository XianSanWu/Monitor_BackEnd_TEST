...
namespace WebAPi.Controllers
{
    public partial class MailHunterController : BaseController
    {
        ...
        public async Task<IActionResult> ExportProjectMailCountCSV([FromQuery] string fileName, MailHunterSearchListRequest searchReq, CancellationToken cancellationToken = default)
        {
            #region 參數宣告
            ...
            data = await _mailHunterService.GetProjectMailCountList(searchReq, cancellationToken).ConfigureAwait(false);
