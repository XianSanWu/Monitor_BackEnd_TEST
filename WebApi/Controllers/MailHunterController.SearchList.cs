...
namespace WebAPi.Controllers
{
    public partial class MailHunterController : BaseController
    {
        ...
        public async Task<ResultResponse<MailHunterSearchListResponse>> GetProjectMailCountList(MailHunterSearchListRequest req, CancellationToken cancellationToken)
        {
            #region 參數宣告
            ...
            result = await _mailHunterService.GetProjectMailCountList(req, cancellationToken).ConfigureAwait(false);
