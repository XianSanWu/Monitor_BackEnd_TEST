...
namespace Models.Entities.Responses
{
    ...
    /// 功能權限定義資料表（模組 / 功能 / 動作）
    /// </summary>
    public class FeaturePermissionEntityResponse
    {
        #region 查詢List回傳
        public class FeaturePermissionEntitySearchListResponse : BaseModel
        {
            #region Properties
            /// <summary>  查詢結果[清單] </summary>
            //public List<FeaturePermissionEntity>? SearchItem { get; set; }
            #endregion
        }
        #endregion
